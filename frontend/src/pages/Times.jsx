    ...
    <div className="space-y-6 pb-20">
      ...
      {teams.length === 0 ? (
        ...
        <div className="space-y-4">
          {teams.map((team) => (
            <div key={team.id} className="card bg-gray-900/40 border border-gray-800 space-y-3">
              ...
              <div className="divide-y">
                {(team.membros || []).length === 0 && <p className="text-sm text-gray-400 py-2">Sem atletas</p>}
                {(team.membros || []).map((m) => (
                  <div key={m.id} className="py-2 flex items-center justify-between">
                    <div>
                      ...
                      <p className="text-xs text-gray-400">ID: {m.atleta_id}</p>
                    </div>
